...
sources:
  ...
  - { id: S2, kind: website, url: "https://acme.example/pricing", entry_page: false, retrieval_status: ok }
  - { id: S3, kind: social_profile, surface: tiktok, url: "https://www.tiktok.com/@acme", retrieval_status: ok }
  - { id: S4, kind: social_content, surface: tiktok, url: "https://www.tiktok.com/@acme/video/1", retrieval_status: ok }
  - { id: S5, kind: social_content, surface: tiktok, url: "https://www.tiktok.com/@acme/video/2", retrieval_status: ok }
  - { id: S6, kind: social_content, surface: tiktok, url: "https://www.tiktok.com/@acme/video/3", retrieval_status: ok }
dimensions:
  ...
  - { id: D4, band: weak, value: 0, sources: [S4, S5, S6], reasoning: "Voice, treatment, and recurring angle differ across all three items" }
...
findings:
  ...
  - { id: F2, sources: [S1, S2], claim: "Pricing lives on a second page and is never referenced in retrieved content" }
missing_angles:
...
ideas:
  ...
  - { id: I3, angle: "Before and after proof", surface: tiktok, format: video, hook: "same room, six weeks apart", addresses: [M2], sources: [S4, S6] }
...
---
Rubric, findings, missing angles, ten ideas, and one written sample creative. No media was
generated, no draft was persisted, and no review link was created.
